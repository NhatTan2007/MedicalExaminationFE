...
import { GeneralDoctorComponent } from './general-doctor/general-doctor.component';
...
const routes: Routes = [
	...
	},
	{
		...
		children: [
			...
			{
				path: 'bac-si-tong-hop',
				component: GeneralDoctorComponent,
				children: [
					{
						path: '',
						loadChildren: () =>
							import('./general-doctor/general-doctor.module').then(
								(g) => g.GeneralDoctorModule
							),
					},
				],
			},
